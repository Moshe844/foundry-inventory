...
test('real-business onboarding grounds facts and asks for source records before reversible settings', { timeout: 30000 }, async () => {
  ...
  assert.match(text, /Choose where my records are/i);
  ...
  assert.doesNotMatch(text, /Save the safe structure|Upload Excel, CSV or files|Connect the system I use|Enter products manually/i);
