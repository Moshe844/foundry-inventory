...
const SCHEMA = { type: 'object', additionalProperties: false,
  required: ['poNumber', 'supplierOrderNumber', 'invoiceNumber', 'trackingNumber', 'expectedShipDate',
    'expectedArrivalDate', 'currency', 'lines', 'confidence', 'warnings'],
  properties: { poNumber: { type: 'string' }, supplierOrderNumber: { type: 'string' }, invoiceNumber: { type: 'string' },
...
decide whether anything can be applied.`;
